...
async function init() {
  try {
    ...
    // 加载AI生成题库
    const genFiles = ['xs_gen_1', 'xs_gen_2', 'xs_gen_3', 'xs_gen_4', 'xs_gen_5', 'xs_gen_6', 'xs_gen_7', 'mg_gen_1', 'mg_gen_2', 'mg_gen_3', 'mg_gen_4', 'mg_gen_5', 'mg_gen_6', 'mg_gen_7', 'ms_gen_1', 'ms_gen_2', 'ms_gen_3', 'ms_gen_4', 'ms_gen_5', 'ms_gen_6', 'ms_gen_7', 'ss_gen_1', 'ss_gen_2', 'ss_gen_3', 'ss_gen_4', 'ss_gen_5', 'ss_gen_6', 'xz_gen_1', 'xz_gen_2', 'xz_gen_3', 'xz_gen_4', 'xz_gen_5', 'xz_gen_6', 'sg_gen_1', 'sg_gen_2', 'sg_gen_3', 'sg_gen_4', 'xf_gen_1', 'xf_gen_2', 'xf_gen_3', 'fx_gen_1', 'fx_gen_2', 'fx_gen_3', 'gj_gen_1', 'gj_gen_2', 'gj_gen_3', 'jj_gen_1', 'jj_gen_2', 'jj_gen_3'];
